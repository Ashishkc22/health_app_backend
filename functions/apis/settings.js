...
router.get('/', async (req, res) => {
    try {
        ...
        var resp = {};
        resp.hospital_category = sts.hospital_category.filter((e) => (e.active || false)).map((e) => e.name);
        resp.doctor_specialization = sts.doctor_specialization.filter((e) => (e.active || false)).map((e) => e.name);
        resp.basic_facilities = sts.basic_facilities.filter((e) => (e.active || false)).map((e) => e.name);
        resp.advance_facilities = sts.advance_facilities.filter((e) => (e.active || false)).map((e) => e.name);
        resp.hospital_rates = sts.hospital_rates.filter((e) => (e.active || false)).map((e) => e.name);
